...
const about = [
  ...
  {
    id: 4,
    text: "4. Played some basketball, broke an arm, not playing anymore",
    emoji: "\u{1F3C0}",
  },
  ...
  //   emoji: "\u{1F355}",
  // },
  { id: 14, text: "14. 'Breaking Bad' all the way!", emoji: "\u{1F4FA}" },
  {
    id: 15,
    text: "15. I got my GF, we like each other pretty darn much",
    emoji: "\u{1F469}",
  },
  { id: 16, text: "16. Lost my hair, gained a beard", emoji: "\u{1F468}" },
  { id: 17, text: "17. Whooping major ass in board games", emoji: "\u{1F3B2}" },
  { id: 18, text: "18. Just kidding, doing this for fun", emoji: null },
  {
    id: 19,
    text: "19. Favorite quote: 'I find your lack of faith... disturbing'",
    emoji: null,
  },
  {
    id: 20,
